load C:/Users/Eylon/Documents/Lumerical/Heater_center_distance/temp/WG/1570.mat;
...
set(ax1, 'XLim', [0.003 0.027])
set(ax1, 'YLim', [0.05 4.45])
set(ax2, 'XLim', [0.003 0.027])
set(ax2, 'YLim', [7.6e-014 2.04e-013])
set(ax1,'XGrid', 'on')
set(ax1,'YGrid', 'on')
